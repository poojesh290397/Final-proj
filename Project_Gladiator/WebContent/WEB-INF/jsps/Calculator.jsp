...
<button onclick="emi_cal()">EMI Calculator</button>
	...
	<div>
		<div class="emi_eli div_left">
			...
			<table cellspacing=3 cellpadding=4 id="eli_cal_cont" class="invisible">
				<form method="post">
					<tr>
					...
					<tr>
						<td>Tenure</td>
						<td><input type="text" name="eliTenure" placeholder="In months" required></td>
					</tr>
					<tr>
						<td>Calculate</td>
		...
		<h2 id="emi_cal_head" class="visible">Emi calculator</h2>
			<table cellspacing=7 cellpadding=7 id="emi_cal_cont" class="invisible">
			   <form method="post">
				   <tr>
				   		<td>Loan</td>
				   		<td><input type="text" name="emiLoan" required></td>
				   </tr>
				   <tr>
						<td>Tenure</td>
						<td><input type="text" name="emiTenure" placeholder="In months" required></td>
				   </tr>
				   <tr>
				    	<td>Roi</td>
				    	<td>8.5%</td> 
...
<div>
	<center>
		<br><br>
			<a href="addPropertyDetails1"><input type="button" value="Apply Now" id="apply_now" /></a>
	</center>
</div>
</body>
</html>
