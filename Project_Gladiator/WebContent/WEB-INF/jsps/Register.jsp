...
<div class="container" id="hi">  
  <form id="contact" action="addDetails" method="post"  modelAttribute="register">
	...
	<fieldset>
     <input name="userPassword"  placeholder="userPassword" type="password" tabindex="1" id="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,19}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 and less than 20 characters" required>
    </fieldset>
    <fieldset>
